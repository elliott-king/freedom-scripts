...
params = (
    (
        "x-algolia-agent",
        "Algolia for vanilla JavaScript (lite) 3.27.0;JS Helper 2.25.1",
    ),
...
data = (
    ...
    "startdate%3E"
    + t
    + '000%22%5D&facetFilters=%5B%22eventtype%3ACarnegie%20Hall%20Presents%22%2C%22eventtype%3AFree%20Events%22%2C%22facilityfacet%3AOffsite%22%2C%5B%22facilityfacet%3AOffsite%22%5D%5D"}]}'
)


def eval():
    return requests.post(
        "https://q0tmlopf1j-dsn.algolia.net/1/indexes/*/queries",
        headers=headers,
        params=params,
        data=data,
    )
